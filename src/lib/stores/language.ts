...
export const translations = {
    en: {
        ...
        noGrowingInfo: 'No growing information available.',
        image: 'Image',
        category: 'Category',
        user: "User",
        ...
        confirmDelete: 'Are you sure you want to delete this Species?',
        confirmDeleteSpecies: 'Are you sure you want to delete this species?',
        ...
        forestManagement: "Manage Food Forests",
    },
    nl: {
        // Navigation
        home: 'Home',
        ...
        plantsList: 'Planten',
        species: 'Soorten',
        createSpecies: 'Soort Aanmaken',
        editSpecies: 'Soort Bewerken',
        update: 'Bijwerken',
        light: 'Licht',
        dark: 'Donker',
        english: 'Engels',
        ...
        noGrowingInfo: 'Geen groei-informatie beschikbaar.',
        image: 'Afbeelding',
        category: 'Categorie',
        user: "Gebruiker",
        ...
        confirmDelete: 'Weet je zeker dat je deze soort wilt verwijderen?',
        confirmDeleteSpecies: 'Weet je zeker dat je deze soort wilt verwijderen?',
