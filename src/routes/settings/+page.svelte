          ...
          >
            ...
            <div class="flex gap-3">
              ...
              <button
                ...
                class="flex-1 bg-(--status-critical) text-primary-foreground px-4 py-2 rounded-lg hover:bg-(--status-critical)/90 transition-colors cursor-pointer"
              >
                {t("delete", $language)}
              </button>
            </div>
...
{#if showConfirmDeleteModal}
  ...
  <div
    class="bg-card border border-border rounded-lg shadow-xl w-full max-w-md p-6 absolute mx-auto left-[50%] top-[50%] -translate-1/2"
    style="z-index: 250;"
  >
